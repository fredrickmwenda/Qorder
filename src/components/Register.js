...
function Register() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSuccessMsg('You have successfully been Registered to Tap4Menu in!');
      navigate('/cart'); 
      // or sessionStorage.setItem('loggedIn', 'true');
    } catch (error) {
      console.error(error);
            ...
            <div class="w-full px-4">
              ...
              >
                ...
                <div class="mb-6">
                  ...
                  <div class="mb-10">
                  <button type="submit" className='border-primary w-full cursor-pointer rounded-md border bg-primary py-3 px-5 text-base  transition duration-300 ease-in-out hover:shadow-md'>Sign Up</button>
                    {/* <input
                      type="submit"
                      value="Sign In"
