        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              <h3 className="sr-only">Reviews</h3>
                 <button className="restaurant-item-favorite-button" >
                    <div className="restaurant-item-favorite mr-4">
                      <UilHeart className='restaurant-item-favorite-icon 4'/>
                    </div>
                </button>
              {/* <div className="flex items-center">
                <div className="flex items-center">
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            ...
            <button
                ...
                className="w-full text-left text-blue-500 hover:text-blue-700 bg-gray-300"
